...
```{r Ozone 2018, fig.width=9,fig.height=4, echo=FALSE, warning=FALSE,fig.cap="2018 monthly Ozone Levels"}


  
#converting month columns from integers to factors
...
#creating a boxplot of ozone levels in 2018
boxplot_18 <-
  ggplot(Ozone_2018, aes(x=factor(month.abb[Ozone_2018$Month],
...
```{r Ozone 2019, fig.width=9,fig.height=4, echo=FALSE, warning=FALSE,fig.cap="2019 monthly Ozone Levels"}
...
#creating a boxplot of ozone levels in 2019
boxplot_19 <-
  ggplot(Ozone_2019, aes(x=factor(month.abb[Ozone_2019$Month],
                           levels=c("Jan", "Feb", "Mar",
                                    "Apr", "May", "Jun", "Jul",
                                    "Aug", "Sep", "Oct",
                                    "Nov", "Dec")),
...
## Git Repository
https://github.com/kendall-fitzgerald/EDE_Fall2024/blob/main/Assignments/KendallFitzgerald_A06_Crafting_Reports.Rmd
